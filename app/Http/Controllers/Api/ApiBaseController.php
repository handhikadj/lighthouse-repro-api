...
class ApiBaseController extends Controller
{
     ...
     * @return json
     */
    public function responseSuccess(array|JsonResource $responseArray)
    {
        if($responseArray instanceof JsonResource) {
            $responseArray = $responseArray->toArray(request());
        }
        $data =
            [
                'status' => true,
    ...
    public function responseValidationError($errors)
    {
        ...
        return $this->setStatusCode(IlluminateResponse::HTTP_UNPROCESSABLE_ENTITY)->responseWithError(trans('api.INPUT_INVALID'), $errors->all());
    }
